...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Sarees", value: "1" },
    { label: "Kurtis", value: "2" },
    { label: "Lehengas", value: "3" },
    { label: "Suits", value: "4" },
    { label: "Dupattas", value: "5" },
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`xl:hidden fixed left-0 right-0 bg-white shadow-lg border-t border-gray-3 transition-all duration-300 ease-out z-9999 ${
          navigationOpen
            ? "opacity-100 visible translate-y-0"
            : "opacity-0 invisible -translate-y-2"
        }`}
        style={{ top: stickyMenu ? "72px" : "140px" }}
      >
              ...
              {menuData.map((menuItem, i) => (
                <li key={i}>
                  <Link
                    ...
                    className="block py-3 px-4 text-dark font-medium hover:bg-gray-1 hover:text-blue rounded-md transition-colors"
                  >
                    {menuItem.title}
                  </Link>
                </li>
